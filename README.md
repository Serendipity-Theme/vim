...
Copy `colors/` to `~/.vim/colors/` and `:colorscheme serendipity-midnight`.

Available files: `colors/serendipity-midnight.vim`, `colors/serendipity-morning.vim`, `colors/serendipity-sunset.vim`.
